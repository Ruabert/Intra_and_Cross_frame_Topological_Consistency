...
class UNet(nn.Module):
    ...
    def __init__(self, in_ch, num_classes, base_ch=32, block='SingleConv', pool=True):
        ...
        self.mid_ED_feature = dict.fromkeys(['x1', 'x2', 'x3', 'x4', 'x5'])
    ...
    def forward(self, x): 
        ...
        self.mid_ED_feature['x1'] = x1
        self.mid_ED_feature['x2'] = x2
        self.mid_ED_feature['x3'] = x3
        self.mid_ED_feature['x4'] = x4
        self.mid_ED_feature['x5'] = x5
