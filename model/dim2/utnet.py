...
class UTNet(nn.Module):
    ...
    def __init__(self, in_chan, base_chan=32, num_classes=1, reduce_size=4, block_list='234', num_blocks=[1, 2, 4],
        ...
        if '0' in block_list:
            ...
            self.up4 = up_block(2 * base_chan, base_chan, num_block=2)
        ...
        if '1' in block_list:
            ...
            self.down1 = down_block(base_chan, 2 * base_chan, num_block=2)
            self.up3 = up_block(4 * base_chan, 2 * base_chan, num_block=2)
        ...
        if '2' in block_list:
            ...
            self.down2 = down_block(2 * base_chan, 4 * base_chan, num_block=2)
            self.up2 = up_block(8 * base_chan, 4 * base_chan, num_block=2)
        ...
        if '3' in block_list:
            ...
            self.down3 = down_block(4 * base_chan, 8 * base_chan, num_block=2)
            self.up1 = up_block(16 * base_chan, 8 * base_chan, num_block=2)
        ...
        if '4' in block_list:
            ...
            self.down4 = down_block(8 * base_chan, 16 * base_chan, num_block=2)
