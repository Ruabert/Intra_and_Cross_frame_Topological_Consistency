...
from model.dim2.tvit_helper import load_pretrained
from model.dim2.tvit_utils import DropPath, to_2tuple, trunc_normal_
from model.dim2.tvit_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
...
class TimeSformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, num_classes=400, num_frames=3, attention_type='divided_space_time',
                 pretrained_model='', **kwargs):
        super(TimeSformer, self).__init__()
        self.pretrained = False
        self.model = VisionTransformer(img_size=img_size, in_chans=1, num_classes=num_classes, patch_size=patch_size, embed_dim=768,
...
if __name__ == '__main__':
    ...
    model = TimeSformer()
    sample = torch.ones((16, 1, 3, 224, 224))
    out1 = model(sample)
